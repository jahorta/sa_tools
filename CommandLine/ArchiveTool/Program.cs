    ...
    static partial class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length == 0)
            {
				...
				Console.WriteLine("Creating an MLD Archive file Files: ArchiveTool -mld <manifestfile> [-astar] [-legacy] \n\tThe tool will package an MLD file automatically from a manifest file.\n-astar: Use A* algorithm for finding triangle strips. Slow but smaller files.\n-legacy: Use legacy packing method. Messier but smaller files.");
